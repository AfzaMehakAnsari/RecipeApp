...
public class InstructionsEquipmentsAdapter extends RecyclerView.Adapter<InstructionsEquipmentsViewHolder>{
    ...
    @Override
    public InstructionsEquipmentsViewHolder onCreateViewHolder(@androidx.annotation.NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@androidx.annotation.NonNull InstructionsEquipmentsViewHolder holder, int position) {
     holder.textView_instructions_step_item.setText(list.get(position).name);
     holder.imageView_instructions_step_items.setSelected(true);
     Picasso.get().load("https://img.spoonacular.com/equipment"+list.get(position).image).into(holder.imageView_instructions_step_items);
    }
